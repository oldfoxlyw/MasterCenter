  ...
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-envelope"></i><span>GM工具</span><span class="label label-important"><i class="icon icon-arrow-down"></i></span></a>
      <ul>
        ...
        <?php if(in_array('master/set_level', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'master/set_honor'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('master/set_honor'); ?>">设置角色荣耀</a></li><?php endif; ?>
