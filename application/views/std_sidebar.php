  ...
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-envelope"></i><span>GM工具</span><span class="label label-important"><i class="icon icon-arrow-down"></i></span></a>
      <ul>
        ...
        <?php if(in_array('master/get_device_id', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'master/get_device_id'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('master/order_check'); ?>">设备码查询</a></li><?php endif; ?>
      </ul>
    </li>
