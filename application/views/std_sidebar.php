  ...
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-envelope"></i><span>GM工具</span><span class="label label-important"><i class="icon icon-arrow-down"></i></span></a>
      <ul>
        ...
        <?php if(in_array('master/set_level', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'master/set_honor'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('master/set_honor'); ?>">增加角色荣耀</a></li><?php endif; ?>
        <?php if(in_array('master/set_level', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'master/set_level'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('master/set_level'); ?>">设置角色等级</a></li><?php endif; ?>
        <?php if(in_array('master/complete_mission', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'master/complete_mission'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('master/complete_mission'); ?>">完成主线任务</a></li><?php endif; ?>
        <?php if(in_array('master/unlock_dungeons', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'master/unlock_dungeons'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('master/unlock_dungeons'); ?>">解锁所有副本</a></li><?php endif; ?>
